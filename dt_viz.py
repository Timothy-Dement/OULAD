...
for clf in ['dt', 'svm', 'nb', 'knn', 'rf']:
    ...
    if not os.path.exists(f'./charts/{clf}'):
        os.mkdir(f'./charts/{clf}')

    results_file = f'./{clf}-results.csv'
    ...
    for option in options:
        ...
        if option == 'compare_attributes':
            ...
            for mod in modules:
                ...
                if mod == 'zzz':
                    mod_plot.set_title(f'{clf.upper()} All Modules Combined')
                else:
                    mod_plot.set_title(f'{clf.upper()} Module {mod.upper()}')
                ...
                mod_plot.figure.savefig(f'./charts/{clf}/atbt_{mod}.png')
            ...
            for mod in modules:
                ...
                mod_plot.figure.savefig(f'./charts/{clf}/smote_{mod}.png')
